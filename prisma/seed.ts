...
async function main() {
  ...
  const serviceTypes = await Promise.all([
    ...
    prisma.serviceType.create({ data: { name: "Fragile Item", code: "fragile", description: "Glassware, ceramics, electronics needing extra care" } }),
    prisma.serviceType.create({ data: { name: "Heavy Cargo", code: "heavy", description: "Shipments exceeding 10kg" } }),
    prisma.serviceType.create({ data: { name: "Liquid / Gel", code: "liquid", description: "Perfumes, oils, non-hazardous liquid items" } }),
    prisma.serviceType.create({ data: { name: "Electronics", code: "electronics", description: "Phones, laptops, accessories" } }),
    prisma.serviceType.create({ data: { name: "Medicine", code: "medicine", description: "Prescription drugs and pharmaceutical cargo" } }),
    prisma.serviceType.create({ data: { name: "Food / Perishable", code: "food", description: "Sweets, dry items, vacuum packed foods" } }),
  ]);
